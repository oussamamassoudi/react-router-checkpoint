...
import Navbarr from './componenst/Navbarr';

import Trailer from './componenst/Trailer';
import { useState } from 'react';
import Movieslist from './componenst/Movieslist';
import { Route, Routes } from 'react-router-dom';
import About from './componenst/About';
import Contact from './componenst/Contact';
import Movietrailer from './componenst/Movietrailer';
...
function App() {
  ...
  return (
    ...
    <Routes>
        ...
        <Route path="/trailer/:id" element={ <Movietrailer movies={movies}/> } />
      </Routes>
    </div>
  );
}
